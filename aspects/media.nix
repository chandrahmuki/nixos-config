{den, ...}: {
    ...
    home-manager.users.${username} = {
      ...
      home.packages = [
        (pkgs.writeShellScriptBin "music-menu" ''
          ...
          INDEX=$(cut -f1 "''${XDG_RUNTIME_DIR:-/tmp}/music_menu_full.list" | fuzzel -d -p "Music ❯ ")
        ...
        (pkgs.writeShellScriptBin "yt-search" ''
          ...
          INDEX=$(echo -e "$RESULTS" | cut -f1 | fuzzel -d -p "Select ❯ ")
  ...
  den.aspects.muggy-nixos.includes = [den.aspects.media];
}
